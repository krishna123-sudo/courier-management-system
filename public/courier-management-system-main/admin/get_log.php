...
<div class="admintitle">
    <div>
        ...
        <h4><a href="logout.php" style="float: right; margin-right:20px; color:aliceblue;">LogOut</a></h4>
    </div>
...
<div style="overflow-x:auto;">
    <table width='80%' border="1px solid" style="margin-left: auto; margin-right:auto; margin-top:30px; font-weight:bold; border-collapse: separate ; border-color: white;">
        <tr style="background-color: indigo; ">
            <th style="color: white;" ><h3>No.</h3></th>
            <th style="color: white;"><h3>User ID</h3></th>
            <th style="color: white;"><h3>Action Time</h3></th>
            <th style="color: white;"><h3>Action Performed</h3></th>
            <th style="color: white;"><h3>Action Performed By</h3></th>
        </tr>
        <?php
